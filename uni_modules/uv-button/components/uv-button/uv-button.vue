...
$uv-button-square-border-top-right-radius: 8px !default;
$uv-button-square-border-top-left-radius: 8px !default;
$uv-button-square-border-bottom-left-radius: 8px !default;
$uv-button-square-border-bottom-right-radius: 8px !default;
