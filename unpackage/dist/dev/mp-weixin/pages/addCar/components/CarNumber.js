...
const _sfc_main = {
  ...
  created() {
    if (this.modelValue != "" && this.modelValue != null) {
      const valList = this.modelValue.split("");
      for (let i in valList) {
        this.inputList[i] = valList[i];
      }
    }
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    a: common_vendor.f($data.inputList, (item, index, i0) => {
      return common_vendor.e({
        a: common_vendor.n($data.curInput == index ? "sel-item-line" : ""),
        b: common_vendor.t(item),
        c: common_vendor.n($data.curInput == index ? "sel-item" : ""),
        d: common_vendor.n($data.maxNum - 1 == index ? "last-item" : ""),
        e: $data.maxNum - 1 == index
      }, $data.maxNum - 1 == index ? {} : {}, {
        f: index === 1 ? 1 : "",
        g: $data.maxNum - 1 === index ? 1 : "",
        h: index,
        i: common_vendor.o(($event) => $options.plateInput(index), index)
      });
    }),
    b: $data.showKeyPop1
  }, $data.showKeyPop1 ? {
    ...
    d: common_vendor.f($data.keyProvince1, (item, index, i0) => {
      return {
        ...
        b: index,
        c: common_vendor.o(($event) => $options.tapKeyboard(item), index)
      };
    }),
    e: common_vendor.f($data.keyProvince2, (item, index, i0) => {
      return {
        a: common_vendor.t(item),
        b: index,
        c: common_vendor.o(($event) => $options.tapKeyboard(item), index)
    ...
    f: common_vendor.f($data.keyProvince3, (item, index, i0) => {
      return {
        a: common_vendor.t(item),
        b: index,
        c: common_vendor.o(($event) => $options.tapKeyboard(item), index)
    ...
    g: common_vendor.f($data.keyProvince4, (item, index, i0) => {
      return {
        a: common_vendor.t(item),
        b: index,
        c: common_vendor.o(($event) => $options.tapKeyboard(item), index)
    ...
    l: common_vendor.f($data.keyEnInput1, (item, index, i0) => {
      return {
        a: common_vendor.t(item),
        b: common_vendor.n($data.lockInput.includes(item) ? "lock-item" : ""),
        c: index,
        d: common_vendor.o(($event) => $options.tapKeyboard(item), index)
      };
    }),
    m: common_vendor.f($data.keyEnInput2, (item, index, i0) => {
      return {
        a: common_vendor.t(item),
        b: common_vendor.n($data.lockInput.includes(item) ? "lock-item" : ""),
        c: index,
    ...
    n: common_vendor.f($data.keyEnInput3, (item, index, i0) => {
      return {
        a: common_vendor.t(item),
        b: common_vendor.n($data.lockInput.includes(item) ? "lock-item" : ""),
        c: index,
    ...
    o: common_vendor.f($data.keyEnInput4, (item, index, i0) => {
      return {
        a: common_vendor.t(item),
        b: common_vendor.n($data.lockInput.includes(item) ? "lock-item" : ""),
        c: index,
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-b1aad1a5"], ["__file", "/Users/wei/driver/pages/addCar/components/CarNumber.vue"]]);
