...
if (!Array) {
  ...
  (_easycom_uv_overlay2 + _easycom_uv_status_bar2 + _easycom_uv_safe_bottom2 + _easycom_uv_image2 + _easycom_uv_transition2)();
}
...
if (!Math) {
  (_easycom_uv_overlay + _easycom_uv_status_bar + _easycom_uv_safe_bottom + _easycom_uv_image + _easycom_uv_transition)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    h: common_vendor.p({
      src: "/static/images/mine/close.png",
      width: "112rpx",
      height: "112rpx",
      duration: 0
    }),
    i: common_vendor.s($options.contentStyle),
    j: common_vendor.n($data.popupClass),
    k: common_vendor.o((...args) => $options.clear && $options.clear(...args)),
    l: common_vendor.o($options.onTap),
    m: common_vendor.p({
      mode: $data.ani,
      name: "content",
    ...
    o: common_vendor.n($data.popupClass),
    p: common_vendor.n($options.isDesktop ? "fixforpc-z-index" : ""),
    q: common_vendor.s({
      zIndex: $props.zIndex
    })
  }) : {});
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-9fc41a34"], ["__file", "/Users/wei/driver/components/my-popup/my-popup.vue"]]);
