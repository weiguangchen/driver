...
P.div = function(y) {
  ...
  var bl, bt, n2, cmp, ri, bz = b.slice(), ai = bl = b.length, al = a.length, r2 = a.slice(0, bl), rl = r2.length, q = y, qc = q.c = [], qi = 0, p2 = dp + (q.e = x.e - y.e) + 1;
  q.s = k;
  k = p2 < 0 ? 0 : p2;
  bz.unshift(0);
  for (; rl++ < bl; )
...
P.sqrt = function() {
  var r2, c, t2, x = this, Big2 = x.constructor, s2 = x.s, e2 = x.e, half = new Big2("0.5");
  if (!x.c[0])
    return new Big2(x);
  if (s2 < 0) {
