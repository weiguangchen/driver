<template>
	<view>
		<view class="car-input-container">
			<view class="car-input-box" :class="{'second-item':index === 1, 'new-item-box': (maxNum - 1) === index }"
				...
				<view class="new-item" v-if="(maxNum-1) == index">新能源</view>
			</view>
		</view>
...
<style scoped lang="scss">
	...
	.car-number-container{
		...
		.plate-popup-item:not(.lock-item):active{
