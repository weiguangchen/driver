		...
		<view @touchstart="touchstart">
			...
			>
				...
				>
					...
					<view style="padding-top: 48rpx;display: flex;justify-content: center;">
						<uv-image src="/static/images/mine/close.png" width="112rpx" height="112rpx" :duration="0" @tap.stop="close"/>
					</view>
				</view>
			</uv-transition>
		</view>
